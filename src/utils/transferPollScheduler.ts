 ...
 * If we polled immediately after, we'd likely see new files start to download. However, as we'd the snapshot only shows queued files,
...
export function transferPollScheduler(
  ...
  let scheduledDelay: number | undefined = undefined;
